...
import { ProfileWithTypedSkills, SkillSchema, SkillType } from "@/server/models/user.schema";
import Painting from "./Painting";

export const techs = ["React", "Vue", "Auth.js", "Tailwind", "Supabase"] as const;
...
export default function EditSkillsButton({
  skills, editNum, portofolio, color = "black", textColor = "white",
  framePosition = [-45 * SCALE + 0.5, wallYPosition * SCALE, 120 - 26 - 24 - 23 - 24 - 23 - 12],
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        ...
                        >
                          {["1","2","3","4","5"].map((lvl) => (
                            <FormItem key={lvl} className="flex items-center space-x-2">
                              <FormControl>
                                <RadioGroupItem value={lvl} />
                              </FormControl>
                              <FormLabel className="font-normal">{lvl}</FormLabel>
                            </FormItem>
                          ))}
                        </RadioGroup>
                      </FormControl>
